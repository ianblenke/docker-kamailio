...
export PUBLIC_TLS_PORT=${PUBLIC_TLS_PORT:-25061}
export PRIVATE_TLS_PORT=${PRIVATE_TLS_PORT:-25061}

export PUBLIC_WS_PORT=${PUBLIC_WS_PORT:-25080}
export PRIVATE_WS_PORT=${PRIVATE_WS_PORT:-25080}
export PUBLIC_WSS_PORT=${PUBLIC_WSS_PORT:-25081}
export PRIVATE_WSS_PORT=${PRIVATE_WSS_PORT:-25081}
